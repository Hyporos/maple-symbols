...
| `cap_unlocked`    | —                                                                | How many people use the experience-cap unlock, which is the source of three known issues (KI-004, KI-005). Low usage means fix them cheaply; high usage means fix them properly. |

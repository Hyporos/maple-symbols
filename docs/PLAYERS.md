...
| Which symbols do people actually track?                              | Where data checks (GAME §5) and Grand Sacred work pay off first.     | Umami: `symbol_select` and `symbol_input` events (ANALYTICS §3).                                                    |

...
Also worth knowing: Geardock arrived last in JMS (2026-08-26) and MSEA (2026-07-20), and MSEA's Geardock daily gives 10, not 15. Every region resets at 00:00 local time, weekly on Thursday. TMS's Sacred and Grand Sacred costs match GMS digit for digit; its Arcane costs and every CMS table are unverified, because the tables in circulation predate the 2023–24 cost reduction and nobody has published a current one. Nobody has published a per-level MSEA table either, so its costs are inferred from the absence of any cost change since 2023. The Geardock daily count in TMS and CMS is unverified. All of this is recorded for the 2.0 decision about whether the site ever shows another region's numbers; today it shows GMS only (I18N §0).

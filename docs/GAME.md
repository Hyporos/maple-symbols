...
- **The weekly resets Thursday 00:00 UTC in GMS**, confirmed in game by Brian on 2026-09-22. It used to be Monday. Every region moved it, each at 00:00 in its own time zone: KMS first on 2025-06-19 (the Assemble update, which unified all weekly content on Thursday), then MSEA v246 on 2025-11-11, GMS v.264 on 2025-11-12, JMS ver4.38 on 2025-12-11, TMS most likely on 2025-12-03 (the beanfun notice is undated) and CMS V222 on 2026-01-07. The official lists name all six Arcane River weeklies (Erda Spectrum to Esfera Guardian); the CMS notice covers all weekly content in one line. Dailies reset at 00:00 local everywhere; for TMS and CMS (UTC+8) that is the convention, since no notice states it. `WEEKLY_RESET_DAY` in `src/lib/utils.ts` holds the day.
...
Also worth knowing: Geardock arrived last in JMS (2026-08-26) and MSEA (2026-07-20), and MSEA's Geardock daily gives 10, not 15. Every region resets at 00:00 local time, weekly on Thursday. TMS's Sacred and Grand Sacred costs match GMS digit for digit; its Arcane costs and every CMS table are unverified, because the tables in circulation predate the 2023–24 cost reduction and nobody has published a current one. Nobody has published a per-level MSEA table either, so its costs are inferred from the absence of any cost change since 2023. The Geardock daily count in TMS and CMS is not published anywhere (probably 15, like every region that raised Tallahart to 15), and MSEA's Talahart count is probably 15 but its notes never name it. All of this is recorded for the 2.0 decision about whether the site ever shows another region's numbers; today it shows GMS only (I18N §0).
...
- **The cost formula** (§1): meso costs are compared with the wiki table, and our table and the Grand Sacred expectations are the formula's output.
...
| 2026-09-22 | GMS v.271 in Nexon's own notes; Grand Sacred counts and reset hours elsewhere      | nexon.com update 44597 (rendered), beanfun V280, 17173 V226, maplesea v251–v253                 | Claude | **GMS official**: Tallahart and Geardock 10 → 15; dailies reset 12:00 AM UTC, weeklies 12:00 AM UTC Thursday. No symbol change announced after v.271. TMS/CMS Geardock count and daily hour, and MSEA Talahart count, not published.      |

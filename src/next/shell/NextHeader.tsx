...
const NextHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-white/6 bg-linear-to-t from-card to-card-grad">
        ...
        <div className="flex items-center gap-3">
          ...
          {isMobile && (
            <button
              ...
              className="flex items-center justify-center rounded-lg p-2 text-secondary hover:text-primary"
            >
